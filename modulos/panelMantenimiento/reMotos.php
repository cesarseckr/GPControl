        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body"><h4 class="card-title"><i class="fa fa-motorcycle"></i>&nbsp; REVISIONES DE MOTOS</h4><hr>
                  <div class="fluid-container">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_moto_r" data-whatever="@mdo"><i class="far fa-clipboard"></i> Nueva revisión</button>
                  ...
                  <input id="variable_f" value="2" style="display:none;">
