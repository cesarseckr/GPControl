			<div class="modal fade" id="add_chasis_r" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
			      ...
			      <div class="modal-body">
					  <div class="form-row">
					    <div class="form-group col-md-12">
					    	<form>
					    		<input id="variable" value="5" style="display:none;">
					    	<div class="row">
						    <div class="form-group col-sm-6">
						      <label for="input">Chasis a revisar</label>
						    ...
						    <div class="form-group col-sm-6">
						      ...
						      <input type="number" class="form-control" placeholder="Kilometraje actual de la unidad" id="km" disabled>
						    </div>
						    <div class="form-group col-sm-6">
						    </div>
      ...
      <small><i>Requiere mantenimiento urgente o servicio correctivo</i></small></p></div>
						    ...
						    <div class="form-group col-sm-4"><br><br><br>
						    	<img class="img-fluid" src="../../images/llantas/chasis.png">
						    </div>
