			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" id="add"><i class="fa fa-plus"></i>&nbsp; Añadir Montacargas</h5>
					    ...
					    <div class="form-group col-md-12">
						  ...
						  <div class="form-group col-sm-6">
						    ...
						    <div class="form-group col-sm-6">
						      ...
						      <input class="form-control" id="marca" placeholder="Marca" data-validation="required" data-validation-error-msg="<p style='color:#B40431;'>Ingrese una marca de montacargas</p>">
						    </div>
						    <div class="form-group col-sm-6">
						      <label for="input" >* Modelo</label>
						      <input class="form-control" type="number" id="modelo" placeholder="Modelo" data-validation="required" data-validation-error-msg="<p style='color:#B40431;'>Ingrese un modelo de montacargas</p>">
						    </div>
						    <div class="form-group col-sm-8">
