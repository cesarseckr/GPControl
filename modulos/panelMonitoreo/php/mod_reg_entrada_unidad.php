<?php 
  ...
  $consulta = mysqli_query($con,"UPDATE reg_ent_sal SET km='$km', disel='$disel', folio='$folio', fecha='$fecha', hora='$hora', tipo='$tipo', comentario='$comentario' WHERE id_viaje='$id_viaje' AND tipo='2'");
