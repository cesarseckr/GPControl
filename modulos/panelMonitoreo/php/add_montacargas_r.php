			<div class="modal fade" id="add_montacargas_r" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
			      ...
			      <div class="modal-body">
					  <div class="form-row">
					    <div class="form-group col-md-12">
					    	<form>
					    		<input id="variable" value="3" style="display:none;">
					    	<div class="row">
						    <div class="form-group col-sm-6">
						      <label for="input">Montacargas a revisar</label>
      ...
      <small><i>Requiere mantenimiento urgente o servicio correctivo</i></small></p></div>
						    ...
						    <div class="form-group col-sm-4"><br>
						    	<img class="img-fluid" src="../../images/llantas/montacargas.png">
						    </div>
