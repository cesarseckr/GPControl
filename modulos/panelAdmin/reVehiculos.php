...
<body>
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php 
		// MODALS //
        include("php/add_vehiculo_r.php");
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body"><h4 class="card-title"><i class="fa fa-truck"></i>&nbsp; REVISIONES DE VEHÍCULOS</h4><hr>
                  <div class="fluid-container">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_vehiculo_r" data-whatever="@mdo"><i class="far fa-clipboard"></i> Nueva revisión</button>
                  ...
                  <input id="variable_f" value="1" style="display:none;">
                ...
                <input type="date" name='fecha_fin_f' id='fecha_fin_f' class="form-control">
                  ...
                  <? include("php/tabla_vehiculos_r.php"); ?>                 
                  </div>
                </div>
              </div>
            </div>
