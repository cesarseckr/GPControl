        ...
        ?>
          <li class="nav-item">
            <a class="nav-link" href="servicio_prev.php">
              ...
              <span class="menu-title">Servicios Preventivo</span> <span class="badge badge-info "> <? echo number_format($unidades); ?> </span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="rev">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="reVehiculos.php"> <i class="fa fa-truck"></i>&nbsp; Vehículos</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="reMotos.php"> <i class="fa fa-motorcycle"></i>&nbsp; Motocicletas</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="reMontacargas.php"> <i class="fa fa-snowplow"></i>&nbsp; Montacargas</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="reDolly.php"> <i class="fa fa-truck-loading"></i>&nbsp; Dolly</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link" href="reChasis.php"> <i class="fa fa-truck-moving"></i>&nbsp; Chasis</a>
                </li>
              </ul>
            </div>
          </li>
