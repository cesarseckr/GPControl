<div class="modal fade" id="add_vehiculo_r" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
		      	...
		      	<div class="modal-body">
					<div class="form-row">
					    <div class="form-group col-md-12">
				    		<input id="variable" value="1" style="display:none;">
				    		<div class="row">
							    <div class="form-group col-sm-6">
							      	<label for="input">Vehículo a revisar</label>
							      	<select class="selectpicker form-control" id="vehiculos" data-live-search="true"></select>
							    </div>
							    ...
							    <div class="form-group col-sm-6">
						      	...
						      	<div class="col-sm-3">
						      		<p class="text-success">
						      			<i class="fa fa-check-circle"></i> BUENO<br>
						      			<small>
						      	...
						      	<div class="col-sm-5">
						      		<p class="text-warning">
						      			<i class="fa fa-exclamation-circle"></i> REGULAR<br>
						      			<small>
						      	...
						      	<div class="col-sm-4">
						      		<p class="text-danger">
						      			<i class="fa fa-exclamation-triangle"></i> MALO<br>
						     	 		<small>
						    	...
						    	<div id="servicios" class="input-group">
						    	</div>
						    	
						    	<div class="form-group col-sm-8">
							    	<div class="form-row">
								    	<div class="form-group col-sm-12">
								    		<b>Observaciones de llantas</b>
								    	</div>
								    	<div class="form-group col-sm-6">
							    ...
							    <div class="form-group col-sm-4">
							    	<br><br><br>
							    	<img class="img-fluid" src="../../images/llantas/vehiculo.png">
							    </div>
							    <div class="form-group col-sm-12">
