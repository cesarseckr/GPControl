...
<html lang="en">
  <head>      
    <!-- Required meta tags -->
      ...
      <title>Global Pacific - Acceder</title>
    <!-- Required meta tags -->
        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
              <center> <img src="images/logo.png" width="230"><hr></center>
                ...
                if(isset($_POST['enviar'])){ 
                  ...
                  while ($result = $sq->fetch(PDO::FETCH_OBJ)){
                    if($result->usuario == $_POST['usuario'] || $result->pass == $_POST['password']){
                      if ($usuario == $result->usuario and $password == $result->pass and $result->estatus == 1){ 
                        $verificar_usuario = true;
                        $verificar_password = true;
                        $verificar_estatus = true;
                      } 
                    }
                  }
                  if($verificar_usuario == true  and $verificar_password == true and $verificar_estatus == true){   
                    $usuario= $_POST['usuario'];
                    $password= base64_encode($_POST['password']);
                    ...
                    foreach ($rows as $row) {
                      ...
                      */
                      ...
                      if ($id_tipo==99) {
                        echo '<meta http-equiv="Refresh" content="0; url=modulos/panelAdmin/index.php">';
                      } else if($id_tipo==1){
                        echo '<meta http-equiv="Refresh" content="0; url=modulos/panelMonitoreo/index.php">';
                      } else if($id_tipo==2){
                        echo '<meta http-equiv="Refresh" content="0; url=modulos/panelMantenimiento/index.php">';
                      }
                    }   
                  }else{
                    echo "
            ...
            <p class="footer-text text-center">Copyright © 2019 Global Pacific.</p>
          </div>
        </div>
      </div>
